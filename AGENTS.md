...
1. **Skills persist, Codex doesn't** - You're training the corpus, not "Codex"
...
```
Codex has no persistent memory. Skills are the ONLY memory.
...
diff -u .Codex/docs/SKILL_FORMAT.md .butler-sync/methodology/SKILL_FORMAT.md
```
...
│                                                             │
│  Methodology docs (.Codex/docs/*.md)                       │
│    └─► OVERWRITTEN (no learnings to preserve)              │
│                                                             │
│  Philosophy docs (.Codex/*.md)                             │
│    └─► OVERWRITTEN (no learnings to preserve)              │
│                                                             │
...
See the [pull-template skill](.Codex/skills/pull-template/SKILL.md) for full workflow.

## Related Documentation

- [META_COGNITIVE_ARCHITECTURE.md](.Codex/docs/META_COGNITIVE_ARCHITECTURE.md) - Full architecture
- [SKILL_FORMAT.md](.Codex/docs/SKILL_FORMAT.md) - Skill file specification
- [SKILL_AUTHORING.md](.Codex/docs/SKILL_AUTHORING.md) - How to write effective skills
- [TDD.md](.Codex/TDD.md) - Test-Driven Development principles
- [SOLID.md](.Codex/SOLID.md) - SOLID principles
- [THREE_VIRTUES.md](.Codex/THREE_VIRTUES.md) - Laziness, Impatience, Hubris
- [LET_IT_CRASH.md](.Codex/LET_IT_CRASH.md) - Erlang-style fault tolerance
